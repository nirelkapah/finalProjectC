...
Error errors[] = {
        ...
        {Error_203, " \"macr\" Command With Extraneous Text"},
        ...
        {Error_208, " \"endmacr\" Command With Extraneous Text"},
        {Error_209, " Empty Macro Content"},
        {Error_210, " \"macr\" Is A Reserved Word"},
        {Error_211, " \"endmacr\" Is A Reserved Word"},
        ...
        {Error_221, "\"macr\" Is A Reserved Word"},
        {Error_222, "\"endmacr\" Is A Reserved Word"},
